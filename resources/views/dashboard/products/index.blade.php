        ...
        <table class="min-w-full leading-normal text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-gray text-sm">
                        <p class="text-gray-900 whitespace-no-wrap">Rp {{ number_format($product->price, 2, ',', '.') }}</p>
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-gray text-sm">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-gray text-sm">
                        ...
                        <flux:badge variant="solid" color="lime">Active</flux:badge>
                        @else
                        <flux:badge variant="solid" color="red" class="text-black">Inactive</flux:badge>
                        @endif
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-gray text-sm">
